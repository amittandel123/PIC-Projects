...
??_Receive: ;@ 0x0
	global	Receive@temp
Receive@temp:	; 1 bytes @ 0x0
	global	Transmit@data1
Transmit@data1:	; 1 bytes @ 0x0
	ds	1
	global	?_main
?_main: ;@ 0x1
	global	?_Transmit
...
;            _Receive
;           _Transmit
;  _Transmit                                          1    0   10   0.00
;                                    0 COMMO    1
;  _Receive                                           1    0   10   0.00
;                                    0 COMMO    1
...
; *************** function _main *****************
; Defined at:
;		line 10 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Receive\Serial_Receive.c"
...
; 
psect	maintext
	file	"D:\Amit\E-Projects\PIC Projects\Serial\Serial Receive\Serial_Receive.c"
	line	10
...
l30000447:	
;Serial_Receive.c: 11: ANSEL=0;
	bsf	status, 6	;RP1=1, select bank2
	clrf	(286)^0100h
	line	12
;Serial_Receive.c: 12: ANSELH=0;
	clrf	(287)^0100h
	
l30000448:	
	line	13
;Serial_Receive.c: 13: OSCCON=0x77;
	movlw	(077h)
...
l30000449:	
	line	14
;Serial_Receive.c: 14: SPBRG=12;
	movlw	(0Ch)
	movwf	(153)^080h
	
l30000450:	
	line	15
;Serial_Receive.c: 15: SYNC=0;
	bcf	(1220/8)^080h,(1220)&7
	
l30000451:	
	line	16
;Serial_Receive.c: 16: SPEN=1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(199/8),(199)&7
	
l30000452:	
	line	17
;Serial_Receive.c: 17: TXEN=1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1221/8)^080h,(1221)&7
	
l30000453:	
	line	19
;Serial_Receive.c: 19: Recd_bit=Receive();
	fcall	_Receive
	movwf	(_Recd_bit)
	
l30000454:	
	line	20
;Serial_Receive.c: 20: Transmit(Recd_bit);
	movf	(_Recd_bit),w
	fcall	_Transmit
...
; *************** function _Transmit *****************
; Defined at:
;		line 35 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Receive\Serial_Receive.c"
; Parameters:    Size  Location     Type
...
;Serial_Receive.c: 34: void Transmit(unsigned char data1)
;Serial_Receive.c: 35: {
	
_Transmit:	
	opt stack 7
; Regs used in _Transmit: [wreg]
;Transmit@data1 stored from wreg
	movwf	(Transmit@data1)
	
l30000461:	
	line	36
;Serial_Receive.c: 36: TXREG=data1;
	movf	(Transmit@data1),w
	movwf	(25)	;volatile
...
; *************** function _Receive *****************
; Defined at:
;		line 24 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Receive\Serial_Receive.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
...
;Serial_Receive.c: 23: unsigned char Receive()
;Serial_Receive.c: 24: {
	
_Receive:	
	opt stack 7
; Regs used in _Receive: [wreg+status,2]
	line	25
	
l30000455:	
;Serial_Receive.c: 25: CREN=1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(196/8),(196)&7
...
l30000457:	
	line	28
;Serial_Receive.c: 28: temp=RCREG;
	movf	(26),w	;volatile
	movwf	(Receive@temp)
	
l30000458:	
	line	29
;Serial_Receive.c: 29: RCIF=0;
	bcf	(101/8),(101)&7
	
l30000459:	
	line	30
;Serial_Receive.c: 30: CREN=0;
	bcf	(196/8),(196)&7
	line	31
;Serial_Receive.c: 31: return(temp);
	movf	(Receive@temp),w
