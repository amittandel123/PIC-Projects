...
;COMMON:	_Display_Data_LCD->_Delay
...
;COMMON:	_Display_Char_LCD->_Delay
	...
	FNCALL	_Display_Data_LCD,_Delay
...
Display_Data_LCD@x:	; 2 bytes @ 0x1
	ds	2
	global	?_Display_Data_LCD
?_Display_Data_LCD: ;@ 0x3
	global	Display_Data_LCD@count
Display_Data_LCD@count:	; 2 bytes @ 0x3
	ds	2
...
;                                    0 COMMO    1
;  _Display_Data_LCD                                  3    2  170   0.00
;                                    0 BANK0    5
;              _Delay
;  _Serial_Init                                       0    0    0   0.00
;  _Initialize_LCD                                    0    0  304   0.00
;   _Send_Command_LCD
;              _Delay
;          _Clear_LCD
;  _Serial_Transmit                                   1    0  268   0.00
;                                    0 BANK0    1
;   _Send_Command_LCD
;              _Delay
;   _Display_Char_LCD
;    _Display_Char_LCD                                1    0   84   0.00
;                                    7 COMMO    1
;              _Delay
;    _Clear_LCD                                       0    0  152   0.00
;   _Send_Command_LCD
;              _Delay
;      _Send_Command_LCD                              1    0   84   0.00
;                                    7 COMMO    1
;              _Delay
;        _Delay                                       7    0   68   0.00
;                                    0 COMMO    7
...
; *************** function _main *****************
; Defined at:
;		line 8 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\main.c"
...
; 
psect	maintext
	file	"D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\main.c"
	line	8
...
l30001266:	
	line	17
;main.c: 17: Display_Data_LCD("LCD is Ready",12);
	movlw	low(0Ch)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(?_Display_Data_LCD)
	movlw	high(0Ch)
	movwf	((?_Display_Data_LCD))+1
...
; Defined at:
;		line 20 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\serial.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
...
; 
psect	text64
	file	"D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\serial.c"
	line	20
	global	__size_of_Serial_Receive
	__size_of_Serial_Receive	equ	__end_of_Serial_Receive-_Serial_Receive
;serial.c: 19: unsigned char Serial_Receive()
;serial.c: 20: {
...
; Defined at:
;		line 31 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
...
; 
psect	text65
	file	"D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
	line	31
	global	__size_of_Display_Data_LCD
	__size_of_Display_Data_LCD	equ	__end_of_Display_Data_LCD-_Display_Data_LCD
;LCD.c: 30: void Display_Data_LCD(unsigned char mdata[], unsigned int count)
;LCD.c: 31: {
...
l30001310:	
	movf	(Display_Data_LCD@count+1),w
	subwf	(Display_Data_LCD@x+1),w
	skipz
	goto	u165
	movf	(Display_Data_LCD@count),w
	subwf	(Display_Data_LCD@x),w
u165:
	skipc
	goto	u161
	goto	u160
...
__ptext66:
	line	43
	signat	_Display_Data_LCD,8312
	global	_Serial_Init

; *************** function _Serial_Init *****************
; Defined at:
;		line 9 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\serial.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
; Defined at:
;		line 11 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30001294:	
;LCD.c: 12: Send_Command_LCD(0x38);
	movlw	(038h)
	fcall	_Send_Command_LCD
	line	13
;LCD.c: 13: Delay(1);
	...
	fcall	_Delay
	line	14
;LCD.c: 14: Send_Command_LCD(0x0C);
	movlw	(0Ch)
	fcall	_Send_Command_LCD
	line	15
;LCD.c: 15: Delay(1);
...
; Defined at:
;		line 31 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\serial.c"
; Parameters:    Size  Location     Type
...
;serial.c: 30: void Serial_Transmit(unsigned char data1)
;serial.c: 31: {
	
_Serial_Transmit:	
	opt stack 6
; Regs used in _Serial_Transmit: [allreg]
...
l30001259:	
	line	34
;serial.c: 34: Send_Command_LCD(0xC0);
	movlw	(0C0h)
	fcall	_Send_Command_LCD
	
l30001260:	
	line	35
;serial.c: 35: Delay(10);
	movlw	(0Ah)
	fcall	_Delay
	
l30001261:	
	line	36
;serial.c: 36: Display_Char_LCD(data1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(Serial_Transmit@data1),w
	fcall	_Display_Char_LCD
...
; Defined at:
;		line 46 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
...
;LCD.c: 45: void Display_Char_LCD(unsigned char a)
;LCD.c: 46: {
...
; *************** function _Clear_LCD *****************
; Defined at:
;		line 56 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30001297:	
;LCD.c: 57: Send_Command_LCD(0x01);
	movlw	(01h)
	fcall	_Send_Command_LCD
	line	58
;LCD.c: 58: Delay(1);
	...
	fcall	_Delay
	line	59
;LCD.c: 59: Send_Command_LCD(0x02);
	movlw	(02h)
	fcall	_Send_Command_LCD
	line	60
;LCD.c: 60: Delay(1);
...
; Defined at:
;		line 21 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
...
;LCD.c: 20: void Send_Command_LCD(unsigned char comd)
;LCD.c: 21: {
...
; *************** function _Delay *****************
; Defined at:
;		line 64 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial_LCD\LCD.c"
; Parameters:    Size  Location     Type
...
;LCD.c: 63: void Delay(unsigned char val)
;LCD.c: 64: {
...
l30001298:	
;LCD.c: 65: unsigned int u,v;
;LCD.c: 66: for(u=0;u<val;u++)
	movlw	low(0)
	movwf	(Delay@u)
	movlw	high(0)
	movwf	((Delay@u))+1
