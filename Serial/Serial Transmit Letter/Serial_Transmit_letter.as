...
_WREN  equ     3170
	global	_WRERR
_WRERR  equ     3171
	file	"Serial_Transmit_letter.as"
	line	#
...
; *************** function _main *****************
; Defined at:
;		line 5 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Transmit Letter\Serial_Transmit_letter.c"
...
; 
psect	maintext
	file	"D:\Amit\E-Projects\PIC Projects\Serial\Serial Transmit Letter\Serial_Transmit_letter.c"
	line	5
...
l30000445:	
;Serial_Transmit_letter.c: 7: OSCCON=0x77;
	movlw	(077h)
	bsf	status, 5	;RP0=1, select bank1
	movwf	(143)^080h	;volatile
	line	8
;Serial_Transmit_letter.c: 8: SPBRG=12;
	movlw	(0Ch)
	movwf	(153)^080h
	
l30000446:	
	line	9
;Serial_Transmit_letter.c: 9: SYNC=0;
	bcf	(1220/8)^080h,(1220)&7
	
l30000447:	
	line	10
;Serial_Transmit_letter.c: 10: SPEN=1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(199/8),(199)&7
	
l30000448:	
	line	11
;Serial_Transmit_letter.c: 11: TXEN=1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1221/8)^080h,(1221)&7
	
l30000449:	
	line	12
;Serial_Transmit_letter.c: 12: Transmit();
	fcall	_Transmit
...
; *************** function _Transmit *****************
; Defined at:
;		line 16 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Transmit Letter\Serial_Transmit_letter.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;Serial_Transmit_letter.c: 15: void Transmit()
;Serial_Transmit_letter.c: 16: {
	
_Transmit:	
	opt stack 7
; Regs used in _Transmit: [allreg]
	line	17
	
l30000450:	
;Serial_Transmit_letter.c: 17: TXREG='T';
	movlw	(054h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(25)	;volatile
...
l30000451:	
	line	19
;Serial_Transmit_letter.c: 19: Delay(10);
	movlw	0Ah
	movwf	(?_Delay)
	clrf	(?_Delay+1)
	fcall	_Delay
...
; *************** function _Delay *****************
; Defined at:
;		line 23 in file "D:\Amit\E-Projects\PIC Projects\Serial\Serial Transmit Letter\Serial_Transmit_letter.c"
; Parameters:    Size  Location     Type
...
;Serial_Transmit_letter.c: 22: void Delay(unsigned int val)
;Serial_Transmit_letter.c: 23: {
...
l30000452:	
;Serial_Transmit_letter.c: 24: unsigned int i,u;
;Serial_Transmit_letter.c: 25: for(i=0;i<val;i++)
	clrf	(Delay@i)
	clrf	(Delay@i+1)
	goto	l30000459
...
l30000453:	
	line	26
;Serial_Transmit_letter.c: 26: for(u=0;u<1000;u++);
	clrf	(Delay@u)
	clrf	(Delay@u+1)
