	...
	;This licence will expire on Wed, 22 Feb 2012
	...
	; Compiler options:
	;
	; -oSerial_Transmit_letter.cof -mSerial_Transmit_letter.map \
	; --summary=default --output=default Serial_Transmit_letter.p1 \
	; --chip=16F690 -P --runtime=default --opt=default -g --asmlist \
