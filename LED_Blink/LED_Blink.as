...
; *************** function _main *****************
; Defined at:
;		line 12 in file "D:\Amit\PIC Projects\LED_Blink\LED_Blink.c"
...
; 
psect	maintext
	file	"D:\Amit\PIC Projects\LED_Blink\LED_Blink.c"
	line	12
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;LED_Blink.c: 11: void main()
;LED_Blink.c: 12: {
...
l30000451:	
;LED_Blink.c: 13: TRISB4=0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1076/8)^080h,(1076)&7
	line	14
;LED_Blink.c: 14: TRISB5=0;
...
l30000454:	
	line	20
;LED_Blink.c: 20: Delay(10);
	movlw	(0Ah)
	fcall	_Delay
	
l30000455:	
	line	21
;LED_Blink.c: 21: RB5=a;
	btfsc	(_a/8),(_a)&7
	goto	u51
	goto	u50
...
; *************** function _Delay *****************
; Defined at:
;		line 6 in file "D:\Amit\PIC Projects\LED_Blink\LED_Blink.c"
; Parameters:    Size  Location     Type
...
l30000443:	
;LED_Blink.c: 7: unsigned int u,v;
;LED_Blink.c: 8: for(u=0;u<val;u++)
	clrf	(Delay@u)
	clrf	(Delay@u+1)
	goto	l30000450
...
l30000444:	
	line	9
;LED_Blink.c: 9: for(v=0;v<1000;v++);
	clrf	(Delay@v)
	clrf	(Delay@v+1)
